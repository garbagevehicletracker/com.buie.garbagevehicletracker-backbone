...
const ProfilesSection = () => {
    ...
    const fetchData = () => {
        fetch('https://garbage-collect-backend.onrender.com/get-all-assigned-work')
            ...
            .catch(error => console.error('Error fetching assigned work data:', error));
    }
                ...
                fetch('https://garbage-collect-backend.onrender.com/get-all-areas')
                    ...
                    .then(areaData => {
                        ...
                        assignedWorkData.forEach(work => {
                            const correspondingDriver = driverData.find(driver => driver.driverId === work.driverId);
                            const correspondingArea = areaData.find(area => area.areaId === work.areaId);
